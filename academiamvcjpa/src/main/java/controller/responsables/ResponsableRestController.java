...
import model.service.ResponsableJpaService;
...
public class ResponsableRestController {
	...
	public ResponseEntity<ResponsableAlumno> obtenerResponsable(@PathVariable("id") Long id)
	...
	public ResponseEntity<Void> crearResponsable(@RequestBody ResponsableAlumno responsable,
			BindingResult bindingResult, UriComponentsBuilder ucBuilder) throws ServiceException, DaoException {
	...
	public ResponseEntity<ResponsableAlumno> actualizarResponsable(@PathVariable("id") long id,
			@RequestBody ResponsableAlumno responsable) throws ServiceException, DaoException {
	...
	public ResponseEntity<ResponsableAlumno> deleteUser(@PathVariable("id") Long id)
			throws ServiceException, DaoException {
		ResponsableAlumno currentResponsable = this.responsableService.buscar(id);
		if (currentResponsable == null) {
			;
